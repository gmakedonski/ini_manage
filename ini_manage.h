 ...
 *	purpose:			
 */
bool ini_set_value  (const char *sec,const char *key, const char *value);		// will auto replace
bool _set_value (const char *sec,const char *key, const char *value,const char *comment,REPLACE_FLAG flag);	// select replace or not replace
